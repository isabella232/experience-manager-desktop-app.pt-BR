...
1. No `logging.json` arquivo, localize todas as instâncias de `"level": "info"`. Altere os valores de `info` para `debug`, que é `"level": "debug"`. Salve e feche o arquivo.
