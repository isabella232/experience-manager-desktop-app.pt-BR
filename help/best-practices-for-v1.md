---
title: Práticas recomendadas do aplicativo para desktop v1.10
description: Recursos principais e uso recomendado do  [!DNL Adobe Experience Manager] aplicativo desktop versão 1.10.
