...
As informações de versão do aplicativo de desktop mais recente versão 2.2.2 estão abaixo. A data de lançamento é 9 de março de 2023.

A versão mais recente do aplicativo de desktop inclui as seguintes correções de erros:

* [Somente Windows] o aplicativo de desktop exibe uma tela em branco após instalar as versões 2.2.0 e 2.2.1.
...
* o aplicativo de desktop exibe a mensagem de erro de tempo limite da sessão ao clicar **[!UICONTROL Sign In]**.
...
* O aplicativo de desktop para de responder ao fazer upload de arquivos em uma pasta que contém caracteres chineses (ASSETS-9237).

* o aplicativo de desktop substitui pontos por traços em nomes de arquivos (ASSETS-10955).
