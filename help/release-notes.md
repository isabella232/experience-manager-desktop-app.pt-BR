...
* Uma nova opção para [!UICONTROL Clear Cookies] é adicionado ao menu principal do aplicativo. Isso ajuda com possíveis problemas de logon, por exemplo, ao alterar a conexão de um servidor para outro. Consulte [limpar cookies antes de conectar](/help/troubleshoot.md#cannot-login-cookies-issue).
